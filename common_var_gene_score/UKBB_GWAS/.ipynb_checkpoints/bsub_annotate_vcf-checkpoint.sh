...
apptainer exec --bind AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/VEP_cache:/VEP_cache/,./sumstats:/sumstats/,./vep_output:/vep_output/ vep.sif \
        vep --dir /VEP_cache/ --cache \
        --offline \
        --format vcf \
        --force_overwrite \
        -i /sumstats/UKBB.AD_GWAS.saige_step2.vcf \
        -o /vep_output/UKBB.AD_GWAS.vep_output.txt \
        --tab \
        --buffer_size 10000 \
        --cache_version 113 \
