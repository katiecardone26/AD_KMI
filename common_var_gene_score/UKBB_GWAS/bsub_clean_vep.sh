...
python clean_vep.py \
        ...
        --coords ADSP_Projects/ADSP_Annotations/VEP_annotation_manual_113/ensembl_start_stop/Homo_sapiens.GRCh38.113.gene_start_stop.autosomes.500kb_upstream_downstream.gtf.txt \
        --known AD_KMI/advp/AD.known_gene_list.for_plotting.txt \
