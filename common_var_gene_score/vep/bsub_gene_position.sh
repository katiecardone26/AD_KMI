...
OUTPUT_SUFFIX=(
        ...
        '.genes.by_position'
        '.genes.by_position'
        '.genes.by_position.500kb_upstream'
        '.genes.by_position.500kb_upstream'
        '.genes.by_position.500kb_upstream'
        '.genes.by_position.500kb_upstream'
        '.genes.by_position.500kb_upstream'
...
CHR_INDEX=${CHR[$INDEX]}
START_COL_INDEX=${START_COL[$INDEX]}
STOP_COL_INDEX=${STOP_COL[$INDEX]}
OUTPUT_SUFFIX_INDEX=${OUTPUT_SUFFIX[$INDEX]}

# load modules
module unload python
module load python

python gene_position.py \
--chrom ${CHR_INDEX} \
--start_col ${START_COL_INDEX} \
--stop_col ${STOP_COL_INDEX} \
--output_suffix ${OUTPUT_SUFFIX_INDEX}