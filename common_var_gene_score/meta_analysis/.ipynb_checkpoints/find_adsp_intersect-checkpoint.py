...
print(sumstats)
## adsp variant list
adsp = pd.read_csv('AD_KMI/common_var_gene_score/igap_adsp_gene_score/ADSP_plink_subset/variant_list/ADSP.mac20.noduplicates.geno0.01.mind0.05.maf0.01.new_var_id.all_chr.snplist',
                    header = None)
print(adsp)
