...
--aou_input AD_KMI/common_var_gene_score/aou_ukbb_meta/aou/sumstats/AOU.AD.${ANCESTRY_INDEX}.all_chr.saige_step2.for_export.txt \
--ukbb_input AD_KMI/common_var_gene_score/aou_ukbb_meta/ukbb/sumstats/UKBB.AD_GWAS.saige_step2.all_chr.for_export.txt \
