...
--input_list AOU_ALL.UKBB.metasoft.ADSP.keep_quest_comb.VEP_v113.gene_by_position.r2_0.1_clump_variants_excluded.RE_pval_threshold_0.05.average_gene_score.logistic_regression_output.txt \
--pval_col_list ADSP:pval \
--es_col_list ADSP:es \
--pval_thres 0.005 \
--output AOU_ALL.UKBB.metasoft.ADSP.keep_quest_comb.VEP_v113.gene_by_position.r2_0.1_clump_variants_excluded.RE_pval_threshold_0.05.average_gene_score