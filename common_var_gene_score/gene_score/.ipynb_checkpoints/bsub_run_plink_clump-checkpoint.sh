...
# clump input
CLUMP_INPUT=(
        "AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.RE_PVAL.plink_clump_input.txt"
        "AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.RE_PVAL.plink_clump_input.txt"
        "AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.RE_PVAL.plink_clump_input.txt"
        "AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.RE_PVAL.plink_clump_input.txt"
        "AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.RE_PVAL.plink_clump_input.txt"
...
CLUMP_INPUT_INDEX=${CLUMP_INPUT[$INDEX]}
PLINK_INPUT_INDEX=${PLINK_INPUT[$INDEX]}
OUTPUT_INDEX=${OUTPUT[$INDEX]}
CHR_INDEX=${CHR[$INDEX]}

module load plink/2.0-20240804

plink --pfile ${PLINK_INPUT_INDEX}${CHR_INDEX} \
--clump ${CLUMP_INPUT_INDEX} \
--clump-p2 1 \
--clump-r2 0.1 \
--out raw_output/${OUTPUT_INDEX}${CHR_INDEX}
