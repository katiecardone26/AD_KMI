...
SUMSTATS=(
        "AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.adsp_intersect.r2_0.1_clump_variants_excluded.RE_pval_threshold_0.05.txt"
)
GENE_ANNOT=(
        'ADSP_Projects/ADSP_Annotations/VEP_annotation_manual_113/VEP_cleaned/ADSP.all_chr.genes.by_position.txt'
