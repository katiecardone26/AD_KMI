...
## sumstats prefix
EXTRACT=(
        "AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.extra_cols.adsp_intersect.cleaned.variant_list.txt"
        "AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.extra_cols.adsp_intersect.cleaned.variant_list.txt"
        "AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.extra_cols.adsp_intersect.cleaned.variant_list.txt"
        "AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.extra_cols.adsp_intersect.cleaned.variant_list.txt"
        "AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.extra_cols.adsp_intersect.cleaned.variant_list.txt"
...
plink2 --pfile AD_KMI/common_var_gene_score/aou_ukbb_meta_adsp_gene_score/adsp/new_var_id/ADSP.mac20.noduplicates.geno0.01.mind0.05.maf0.01.new_var_id.chr${CHR_INDEX} \
