...
#BSUB -J "make_plink_clump_input[1-22]"
...
## sumstats prefix
EXTRACT=(
        "/project/ritchie/projects/AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.extra_cols.adsp_intersect.cleaned.variant_list.txt"
        "/project/ritchie/projects/AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.extra_cols.adsp_intersect.cleaned.variant_list.txt"
        "/project/ritchie/projects/AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.extra_cols.adsp_intersect.cleaned.variant_list.txt"
        "/project/ritchie/projects/AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.extra_cols.adsp_intersect.cleaned.variant_list.txt"
        "/project/ritchie/projects/AD_KMI/common_var_gene_score/aou_ukbb_meta/metasoft/output/AD.AOU_ALL.UKBB.no_adjustment.metasoft_output.extra_cols.adsp_intersect.cleaned.variant_list.txt"
...
OUTPUT_PREFIX=(
        "input/AD.AOU_ALL.UKBB.no_adjustment.metasoft.ADSP.all_variants.plink_clump_input.chr"
        "input/AD.AOU_ALL.UKBB.no_adjustment.metasoft.ADSP.all_variants.plink_clump_input.chr"
        "input/AD.AOU_ALL.UKBB.no_adjustment.metasoft.ADSP.all_variants.plink_clump_input.chr"
        "input/AD.AOU_ALL.UKBB.no_adjustment.metasoft.ADSP.all_variants.plink_clump_input.chr"
        "input/AD.AOU_ALL.UKBB.no_adjustment.metasoft.ADSP.all_variants.plink_clump_input.chr"
...
plink2 --pfile /project/ritchie/projects/AD_KMI/common_var_gene_score/igap_adsp_gene_score/ADSP_plink_subset/new_var_id/ADSP.mac20.noduplicates.geno0.01.mind0.05.maf0.01.new_var_id.chr${CHR_INDEX} \
