...
# output
PLINK_OUTPUT=(
        "AD.AOU_ALL.UKBB.no_adjustment.metasoft.RE_PVAL.ADSP.all_variants.r2_0.1.plink_clump_output.chr"
        "AD.AOU_ALL.UKBB.no_adjustment.metasoft.RE_PVAL.ADSP.all_variants.r2_0.1.plink_clump_output.chr"
        "AD.AOU_ALL.UKBB.no_adjustment.metasoft.RE_PVAL.ADSP.all_variants.r2_0.1.plink_clump_output.chr"
        "AD.AOU_ALL.UKBB.no_adjustment.metasoft.RE_PVAL.ADSP.all_variants.r2_0.1.plink_clump_output.chr"
        "AD.AOU_ALL.UKBB.no_adjustment.metasoft.RE_PVAL.ADSP.all_variants.r2_0.1.plink_clump_output.chr"
...
# bash commands
## lead SNP lists
cut -f3 raw_output/${PLINK_OUTPUT_INDEX}${CHR_INDEX}.clumps | grep -v 'ID' > clean_output/${PLINK_OUTPUT_INDEX}${CHR_INDEX}.lead_snps.txt
## summary files
cut -f1-10 raw_output/${PLINK_OUTPUT_INDEX}${CHR_INDEX}.clumps > clean_output/${PLINK_OUTPUT_INDEX}${CHR_INDEX}.summary.txt

# python command
python clean_clump_outputs.py \
--input raw_output/${PLINK_OUTPUT_INDEX}${CHR_INDEX}.clumps \
--output_prefix clean_output/${PLINK_OUTPUT_INDEX}${CHR_INDEX}
