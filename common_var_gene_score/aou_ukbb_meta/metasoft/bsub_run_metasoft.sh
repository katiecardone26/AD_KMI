...
java -jar metasoft/Metasoft.jar \
     -input input/AD.AOU_${ANCESTRY_INDEX}.UKBB.metasoft_input.union.txt \
     -pvalue_table metasoft/HanEskinPvalueTable.txt \
     -output output/AD.AOU_${ANCESTRY_INDEX}.UKBB.no_adjustment.metasoft_output.txt \
     -log logs/AD.AOU_${ANCESTRY_INDEX}.UKBB.no_adjustment.log
