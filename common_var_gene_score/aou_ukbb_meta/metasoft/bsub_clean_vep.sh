...
python clean_vep.py \
--vep vep_output/AD.AOU_${ANCESTRY_INDEX}.UKBB.FINNGEN.no_adjustment.metasoft.vep_output.txt \
--output_prefix vep_output/AD.AOU_${ANCESTRY_INDEX}.UKBB.FINNGEN.no_adjustment.metasoft