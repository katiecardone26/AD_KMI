...
def make_arg_parser():
    ...
    parser.add_argument('--omics_type', required = True, help = 'omics type', choices = ['genomics', 'multiomics'])
...
if omics_type == 'genomics':
    ...
    # 9. concatenate dfs
    all_omics = pd.concat([rnaseq_rosmap,
                        rnaseq_10_msbb,
                        rnaseq_22_msbb,
                        rnaseq_36_msbb,
                        rnaseq_44_msbb,
...
# export
gene_avg_pathway_score.to_csv(('pathway_score/rosmap/avg_pathways/ADSP.' + omics_type + '.gene_average.pathway_scores.' + output_tag + '.txt'),
sep = '\t',
na_rep = 'NaN')
...
if omics_type == 'multiomics':
    ...
    pathway_score_avg_pathway.to_csv(('pathway_score/rosmap/avg_pathways/ADSP.' + omics_type + '.pathway_average.pathway_scores.' + output_tag + '.txt'),
    sep = '\t',
    na_rep = 'NaN')