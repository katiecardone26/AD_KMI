...
input_dir = 'AD_KMI/ML/statistical_models/input/'
...
output_dir = 'AD_KMI/ML/statistical_models/lr_output/iterations/'
...
# export dfs
output_dir = 'AD_KMI/ML/statistical_models/omics_weights/'
